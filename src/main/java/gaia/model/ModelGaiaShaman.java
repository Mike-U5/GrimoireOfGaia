...
public class ModelGaiaShaman extends ModelBase {
	...
	public ModelGaiaShaman() {
		...
		this.backpack = new ModelRenderer(this, 66, 12);
		this.backpack.addBox(-3F, 6F, -1F, 6, 4, 3);
		...
		this.waist01 = new ModelRenderer(this, 66, 19);
		...
		this.waist02 = new ModelRenderer(this, 66, 29);
		this.waist02.addBox(-3.5F, 11F, -1.5F, 7, 7, 4);
		...
		this.rightbracelet = new ModelRenderer(this, 66, 6);
		this.rightbracelet.addBox(-2.5F, 4F, -1.5F, 3, 3, 3);
		this.rightbracelet.setRotationPoint(-2.5F, 2.5F, 0F);
		this.rightbracelet.setTextureSize(64, 32);
		this.rightbracelet.mirror = true;
		this.setRotation(rightbracelet, 0F, 0F, 0.0872665F);
		this.rightpauldron = new ModelRenderer(this, 66, 0);
		this.rightpauldron.addBox(-4F, -1.5F, -1.5F, 4, 3, 3);
		...
		this.leftpauldron.addBox(0F, -1.5F, -1.5F, 4, 3, 3);
	...
	public void render(Entity entity, float par2, float par3, float par4, float par5, float par6, float par7) {
		...
		this.rightbracelet.render(par7);
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6) {
		...
		this.hat01.rotateAngleY = this.head.rotateAngleY;
		this.hat01.rotateAngleX = this.head.rotateAngleX + 1.047198F;
		this.hat02.rotateAngleY = this.head.rotateAngleY;
		this.hat02.rotateAngleX = this.head.rotateAngleX + 1.047198F;
		this.horns.rotateAngleY = this.head.rotateAngleY;
		this.horns.rotateAngleX = this.head.rotateAngleX + 1.047198F;
		this.rightarm.rotateAngleX = MathHelper.cos(par1 * 0.6662F + (float)Math.PI) * 0.2F * par2 * 0.5F;
		this.rightbracelet.rotateAngleX = this.rightarm.rotateAngleX;
        ...
        if (this.onGround > -9990.0F)
        {
            ...
            this.rightbracelet.rotateAngleY = this.rightarm.rotateAngleY;
            ...
            this.rightbracelet.rotateAngleZ = this.rightarm.rotateAngleZ + 0.0872665F;
            this.rightpauldron.rotateAngleZ = this.rightarm.rotateAngleZ - 0.0872665F;
