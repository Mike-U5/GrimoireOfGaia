...
public class ModelGaiaFleshLich extends ModelBase {
    ...
    public ModelGaiaFleshLich() {
    	...
    	this.rightshoulderlower.mirror = true;
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6) {
		...
		this.headlower.rotateAngleY = this.head.rotateAngleY;
		this.headlower.rotateAngleX = this.head.rotateAngleX;
		...
		this.rightshoulderlower.rotateAngleX = this.rightarm.rotateAngleX + 0.0872665F;
        ...
        if (this.onGround > -9990.0F)
        {
            ...
            this.rightshoulder.rotateAngleX = this.rightarm.rotateAngleX;
            this.rightshoulderlower.rotateAngleX = this.rightarm.rotateAngleX;
            this.rightarm.rotateAngleY += (this.body.rotateAngleY * 2.0F);
            this.rightshoulder.rotateAngleY = this.rightarm.rotateAngleY;
            this.rightshoulderlower.rotateAngleY = this.rightarm.rotateAngleY;
            ...
            this.rightshoulderlower.rotateAngleZ = this.rightarm.rotateAngleZ + 0.0872665F;
        }
	}
}
