...
public class RenderWeaponBookBattle implements IItemRenderer {

	protected ModelWeaponBook bookModel = new ModelWeaponBook();

	public boolean handleRenderType(ItemStack item, ItemRenderType type) {
		switch(RenderWeaponBookBattle.NamelessClass1923601102.$SwitchMap$net$minecraftforge$client$IItemRenderer$ItemRenderType[type.ordinal()]) {
		case 1:
			return true;
		case 2:
			return true;
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object ... data) {
		...
		case 2:
			...
			Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("gaia", "textures/models/weapons/WeaponBookBattle.png"));
